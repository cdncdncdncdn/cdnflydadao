...
cd /opt/
download "https://github.com/cdncdncdncdn/cdnflydadao/raw/main/master/$tar_gz_name" "https://github.com/cdncdncdncdn/cdnflydadao/raw/main/master/$tar_gz_name" "$tar_gz_name"
